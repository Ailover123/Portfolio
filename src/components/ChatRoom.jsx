...
export default function ChatRoom() {
  ...
  if (!auth || !db) {
    return (
      <div className="bg-zinc-900 border border-yellow-700/50 p-6 rounded-xl shadow-lg max-w-xl mx-auto mt-5 text-center">
        <h2 className="text-2xl font-bold mb-4 text-white">💬 Chat Room</h2>
        <p className="text-yellow-500 bg-yellow-950/30 p-4 rounded-lg border border-yellow-900/50 italic">
          Firebase credentials missing. Check <code>src/firebase.js</code> to enable chat.
        </p>
      </div>
    );
  }
