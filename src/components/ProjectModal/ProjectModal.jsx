...
import { FiX, FiGithub } from 'react-icons/fi'; // Install react-icons if not yet installed: npm install react-icons
...
const ProjectModal = ({ isOpen, onClose, project }) => {
  ...
  const handleClose = () => {
    setIsClosing(true);
    // Wait for animation to finish (300ms) before calling onClose from props
    setTimeout(() => {
      onClose();
