        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/nishal3.png" className="w-14 aspect-square object-cover object-top rounded-full" style={{ imageRendering: 'auto' }} />
              <q>Engineering solutions, not just code.</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Nishal Gopal Poojary" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="A passionate Android & AI developer dedicated to crafting modern, high-performance digital experiences through innovative and user-friendly solutions."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a
                href="./assets/CV1.pdf"
                download="Nishal_Poojary_CV.pdf"
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              name="Nishal Poojary"
              title="Android and AI Developer"
              handle="nishalpoojary71"
              status="Online"
              contactText="Contact Me"
              avatarUrl="./assets/nishal.png"
              showUserInfo={true}
              enableTilt={true}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I’m Nishal Gopal Poojary, passionate about building modern, high-performance applications with an intuitive user experience. I enjoy working with the latest technologies like Artificial Intelligence, Machine Learning, and Android Applications, blending creativity with precision to deliver impactful solutions. I’m committed to helping users and businesses grow in the digital era through functional, aesthetic, and scalable digital products."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      7.75<span className="text-violet-500">/10.00</span>
                    </h1>
                    <p>GPA</p>
                  </div>
                </div>
                ...
                <ShinyText
                  text="Working with passion, creating with mind."
                  disabled={false}
                  speed={3}
